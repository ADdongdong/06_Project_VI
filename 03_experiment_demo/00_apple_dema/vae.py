...
class Encoder(nn.Module):
    def __init__(self, z_dim, hidden_dim):
        ...
        self.fc0 = nn.Linear(784, hidden_dim)
        self.fc20 = nn.Linear(hidden_dim, z_dim)
    ...
    def forward(self, x):
        ...
        hidden = self.softplus(self.fc0(x))
        # then return a mean vector and a (positive) square root covariance
        # each of size batch_size x z_dim
        z_loc = self.fc20(hidden)
        z_scale = torch.exp(self.fc21(hidden))
